...
public class Colosseum {
    ...
    /**
     * We split 50 points between attack and defense.
     */
    static final int SPLIT_ATTACK_AND_DEFENSE = 50;
    ...
    public static Pokemon buildPokemon() {
        ...
        System.out.println("Please new your new Pokemon:");
        String tempName = scan.next();
        System.out.println("How many hit points will it have? (1-50): ");
        int tempHitpoints = scan.nextInt();
        while (tempHitpoints < 1 || tempHitpoints > MAX_HIT_POINTS) {
            System.out.println("Sorry. Hit points must be between 1 and 50: ");
            tempHitpoints = scan.nextInt();
        }
        System.out.println("Split fifty points attack level and defense level");
        System.out.println("Enter your attack level (1-49): ");
        int tempAttack = scan.nextInt();
        while (tempAttack < 1 || tempAttack > SPLIT_ATTACK_AND_DEFENSE - 1) {
            System.out.println("Sorry. The attack level must be between 1 and 49: ");
            tempAttack = scan.nextInt();
        }
        int maxDefense = SPLIT_ATTACK_AND_DEFENSE - tempAttack;
        System.out.println("Enter your defense level (1-" + maxDefense + "): ");
        int tempDefense = scan.nextInt();
        while (tempDefense < 1 || tempDefense > maxDefense) {
            System.out.println("Sorry. The defense level must be between 1 and "
                    + maxDefense + ":");
            tempDefense = scan.nextInt();
        }
